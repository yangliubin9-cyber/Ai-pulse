...
export const zh = {
  ...
  pages: {
    ...
    changelog: {
      title: '更新日志',
      description: '这个站点一路走来的主要变化。',
      v010Title: 'v0.1.0 · 初版',
      v010Date: '2026 年初',
      v010l1: '接入 RSS 官方博客、Hacker News、arXiv 多源聚合。',
      v010l2: '卡片流首页与登录守卫。',
      v011Title: 'v0.1.1 · 体验打磨',
      v011Date: '近期',
      v011l1: '深色 UI 主题与时间轴式资讯流。',
      v011l2: '热度徽章、关键词搜索与分类 / 来源筛选。',
      v011l3: '中英双语国际化。',
      v011l4: '站内文章详情页，点卡片在站内阅读。',
    },
    feedback: {
      title: '反馈',
